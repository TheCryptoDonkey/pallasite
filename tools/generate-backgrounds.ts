...
const WAVES: WavePrompt[] = [
  {
    wave: 1,
    prompt: `Photorealistic deep-space astrophotography, ultra-high resolution, captured in the style of a Hubble Space Telescope wide-field image. A distant blue ice gas giant on the right side of the frame, partially in shadow, with subtle atmospheric blue rim lighting and visible cloud bands. Faint cyan-blue interstellar dust clouds wisp through the upper-left quadrant. Tens of thousands of pinpoint stars at varying brightness scattered across deep black space. The lower-centre of the frame is a quiet dark void. No text, no graphics, no UI elements, no spaceships, no asteroids, no characters, no logos. Cinematic, awe-inspiring, scientifically plausible. Aspect 2560x1440.`,
  },
  {
    wave: 2,
    prompt: `Photorealistic deep-space astrophotography, ultra-high resolution, in the style of a James Webb Space Telescope NIRCam composite. A glowing warm orange and amber emission nebula dominates the upper portion with delicate filamentary dust structures and dark Bok globules. Two airless moons in the lower-right corner — one heavily cratered grey, one rocky red, both lit from a distant unseen star — partially in shadow. Black space background dotted with thousands of pinpoint stars. The lower-centre region is a darker quiet void. No text, no graphics, no UI, no spaceships, no asteroids. Cinematic, scientifically plausible, awe-inspiring. Aspect 2560x1440.`,
  },
  {
    wave: 3,
    prompt: `Photorealistic deep-space astrophotography, ultra-high resolution, in the style of a Cassini-quality planetary photograph composited with deep-field background. A teal-cyan emission nebula glowing in the upper portion of the frame. A massive ringed gas giant (Saturn-like) in the lower-left, deep amber and pale gold colours with intricate visible ring banding casting a thin shadow on the planet. Realistic phase shading and atmospheric haze. Distant pinpoint stars filling deep black space. Lower-centre quiet void. No text, no graphics, no UI, no spaceships, no asteroids. Cinematic, scientifically plausible. Aspect 2560x1440.`,
  },
  {
    wave: 4,
    prompt: `Photorealistic deep-space astrophotography, ultra-high resolution, captured in the style of an ESO long-exposure colour composite. A deep purple and violet reflection nebula filling the upper two-thirds of the frame with glowing magenta filaments and dark dust lanes. A close binary star system at upper right — one brilliant white-blue main sequence star, one dimmer orange giant — with realistic diffraction spike patterns. Pinpoint stars throughout. Lower-centre is a darker void. No text, no graphics, no UI, no spaceships, no asteroids. Cinematic, scientifically plausible, painterly. Aspect 2560x1440.`,
  },
  {
    wave: 5,
    prompt: `Photorealistic deep-space astrophotography, ultra-high resolution, in the style of a JWST mid-infrared image of a star-forming region. A vivid crimson and deep red emission nebula with darker dust lanes and bright young star clusters embedded in the cloud, dominating the upper centre. A heavily cratered grey-brown airless moon in the lower-right with realistic regolith texture and Earthshine-like rim lighting. Distant pinpoint stars across deep black space. Lower-centre quiet void. No text, no graphics, no UI, no spaceships, no asteroids. Cinematic, scientifically plausible. Aspect 2560x1440.`,
  },
  {
    wave: 6,
    prompt: `Photorealistic deep-space astrophotography, ultra-high resolution, captured in the style of a Hubble + ground-based long-exposure mosaic of the Andromeda galaxy (M31). The galaxy seen at three-quarter angle filling most of the frame, dramatic and large. Spiral arms in vivid layered colour: deep magenta and pink in the outer arms, golden-amber bright core, warm orange in the inner spiral, electric blue and ultraviolet in star-forming regions, emerald-green and brown dust lanes. Scattered cyan and white star clusters along the arms. Subtle dark dust banding crossing brighter regions. Surrounding deep black space dotted with pinpoint stars. Lower-centre quiet void. No text, no graphics, no UI, no spaceships, no asteroids. Cinematic, scientifically plausible, painterly. Aspect 2560x1440.`,
  },
  {
    wave: 7,
    prompt: `Photorealistic deep-space astrophotography, ultra-high resolution, in the style of a Hubble plus ground-based long-exposure of the Pleiades open star cluster (M45, known in Japan as Subaru — fitting for a Japanese 1898 specimen). Several brilliant young blue-white stars dominate the upper portion of the frame, each with subtle diffraction spikes. Surrounding intricate cobalt-blue reflection nebulosity — wispy filaments and streamers of interstellar dust catching the starlight, layered with darker dust lanes. Subtle background of warmer gold and soft amber. Distant pinpoint stars across deep black space. Lower-centre quiet void. No text, no graphics, no UI, no spaceships, no asteroids. Cinematic, scientifically plausible, painterly, distinct from any black-hole imagery. Aspect 2560x1440.`,
  },
  {
    wave: 8,
    prompt: `Photorealistic deep-space astrophotography, ultra-high resolution, in the style of a JWST close-up of a gas giant. A massive gas giant in the lower-centre with bold horizontal storm bands in turquoise, deep navy blue, ultraviolet, magenta, and violet, plus visible cyclonic vortices and a Great Red Spot analogue. A subtle ring system tilted slightly, with realistic ring shadow on the planet's surface. A pink-violet ionised nebula in the upper portion. Distant pinpoint stars. Lower-centre quiet void around the planet's lower edge. No text, no graphics, no UI, no spaceships, no asteroids. Cinematic, scientifically plausible. Aspect 2560x1440.`,
  },
  {
    wave: 9,
    prompt: `Photorealistic deep-space astrophotography, ultra-high resolution, in the style of an ESA / Cassini-quality planetary image composited with auroral data. A pale blue ice planet in the centre-right with cracked tectonic surface, polar caps shimmering with bright green and pink auroras, subtle ring of dust around it. Soft teal nebula glow surrounding the planet. Distant pinpoint stars across deep black space. Lower-centre dark void. No text, no graphics, no UI, no spaceships, no asteroids. Cinematic, scientifically plausible. Aspect 2560x1440.`,
  },
  {
    wave: 10,
  ...
  {
    wave: 18,
    prompt: `Photorealistic deep-space astrophotography, ultra-high resolution, in the style of a Cassini high-detail planetary close-up composited with deep field. A close-up of a brown dwarf — dim red-brown sphere with subtle banding and storm patterns — at the right of the frame, glowing faintly from its own residual heat. Surrounding sparse pinpoint stars. Subtle dust glow in the upper portion. Lower-centre quiet void. No text, no graphics, no UI, no spaceships, no asteroids. Cinematic, scientifically plausible. Aspect 2560x1440.`,
  },
  {
    wave: 19,
    prompt: `Photorealistic deep-space astrophotography, ultra-high resolution, JWST style. A neutron star at the upper centre — tiny but blindingly bright with diffraction spikes, surrounded by its rotating pulsar wind nebula in shades of electric blue, white, and violet, intricate filaments and shock fronts. Surrounding deep black space and pinpoint stars. Lower-centre quiet void. No text, no graphics, no UI, no spaceships, no asteroids. Cinematic, scientifically plausible, intense. Aspect 2560x1440.`,
  },
  {
    wave: 20,
    prompt: `Photorealistic deep-space astrophotography, ultra-high resolution, Hubble + JWST composite style. Vast dust lane crossing the frame diagonally — interstellar dust in browns and reds with embedded dark Bok globules. Bright young blue stars peeking through the gaps. Faint magenta-pink emission glow behind the dust. Pinpoint background stars throughout deep black space. Lower-centre quiet void. No text, no graphics, no UI, no spaceships, no asteroids. Cinematic, scientifically plausible, painterly. Aspect 2560x1440.`,
  },
  {
    wave: 21,
    prompt: `Photorealistic deep-space astrophotography, ultra-high resolution, in the style of a JWST close-up of a young protoplanetary disc. A central T Tauri young star with a tilted dusty disc visible edge-on, dark in the silhouette plane, glowing pink-orange around the edges where the star illuminates it. Bipolar polar jets shooting upward and downward from the disc poles. Surrounding deep black space with pinpoint stars. Lower-centre quiet void. No text, no graphics, no UI, no spaceships, no asteroids. Cinematic, scientifically plausible. Aspect 2560x1440.`,
  },
  {
    wave: 22,
...
const SANCTUM_PROMPT: NamedPrompt = {
  name: 'sanctum',
  prompt: `Photorealistic dramatic landscape, ultra-high resolution, cinematic mythic register. Madeira volcanic basalt cliffs viewed from a high vantage at storm-light golden hour. Towering jagged black basalt headlands silhouetted in the lower-left and lower-right thirds, weathered and ancient. Vast tempestuous Atlantic sky fills the upper two-thirds — a cathedral of layered ember orange, burnished gold, deep amber, and storm-charged crimson, with massive crepuscular rays piercing through ragged stratus clouds. Distant ocean horizon catching the molten light. Faint sparks and embers drifting upward from the cliffs as if the rock itself is alive. The lower-centre is a darker quiet void where the ocean lies in deep shadow. No text, no graphics, no UI, no spaceships, no asteroids, no boats, no characters, no buildings, no figures, no logos. Cinematic, mythic, scripture-like, awe-inspiring, painterly. Aspect 2560x1440.`,
};
