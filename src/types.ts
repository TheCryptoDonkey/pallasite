...
export const SHIP_ROT_ACCEL = 18;     // rad/s² when key held — snappy ramp to turn speed
export const SHIP_ROT_DAMPING = 18;   // rad/s² counter — stops fast on release so aim doesn't overshoot
export const SHIP_MAX_ROT = 5.4;      // rad/s — quick top turn (booth feedback: ship felt sluggish)
